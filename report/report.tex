...
\begin{figure}
\centering
\includegraphics[width=0.9\textwidth]{figures/aggmean.pdf}
...
\begin{figure}
\centering
\includegraphics[width=0.5\textwidth]{figures/distribution.png}
\caption{Distribution of total placement times for each interface. Whiskers are
1.5 IQR in length. Note that three outliers for the 2D gesture interface are not
shown}
\label{fig:distr}
\end{figure}
...
in mouse interface times ($p > 0.05$) or between the 3D-gesture and either mouse
interface ($p > 0.05$).

\begin{figure}
\centering
\includegraphics[width=0.5\textwidth]{figures/mean.pdf}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.5\textwidth]{figures/mousebygesture3d.png}
\caption{Relative completion times for 3D mouse and 2D mouse interfaces,
normalized by 3D gesture completion times. \\
Legend: Red x denotes severe problems with stereoscopic perception. Red +
...
\begin{figure}[h]
\centering
\includegraphics[width=0.5\textwidth]{figures/gesturebymouse2d.png}
